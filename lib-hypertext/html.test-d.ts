...
import type * as hypertextHtml from '@/html.ts'
...
type Actual<Tag extends keyof typeof hypertextHtml.html> = Readonly<
  Required<Parameters<(typeof hypertextHtml.html)[Tag]>[0]>
>

type ActualForType<
  Tag extends keyof typeof hypertextHtml.html,
  Type extends string,
> = Actual<Tag> & { readonly type: Type }

type Expected<Tag extends keyof HTMLElementTagNameMap> =
  hypertextElementAttrTest.TestAttrs<unknown, HTMLElementTagNameMap[Tag]>
