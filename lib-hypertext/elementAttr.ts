...
export type Attrs<CustomContext, BaseElement extends Element> = PickAttrs<
  ...
  | 'tabIndex'
> & {
  readonly content?: hypertextFragment.FragmentOpt<CustomContext>
...
export interface OnAddEvent<BaseElement extends Element> {
  readonly ctx: hypertextContext.ScopedContext
...
export const allAttrs = {
  ...
  height: stringAttr<hypertextData.SvgLengthPctOpt>('height'),
  ...
  preserveAspectRatio: stringAttr<hypertextData.SvgPreserveAspectRatioOpt>(
    'preserveAspectRatio',
  ),
  ...
  rx: stringAttr<hypertextData.SvgLengthPctOpt>('rx'),
  ry: stringAttr<hypertextData.SvgLengthPctOpt>('ry'),
  ...
  viewBox: stringAttr<hypertextData.Rect>('viewBox'),
  width: stringAttr<hypertextData.SvgLengthPctOpt>('width'),
  x: stringAttr<hypertextData.SvgLengthPctOpt>('x'),
  y: stringAttr<hypertextData.SvgLengthPctOpt>('y'),
}
