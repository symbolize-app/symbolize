...
export const tests = {
  ...
  async ['div pure'](
    ...
    const fragment = hypertext.html.div({
      ariaDisabled: true,
      id: 'x',
  ...
  async ['div state'](
    ...
    const fragment = hypertext.html.div({ id: x })
    const body = await hypertextTest.addFragmentToBody(ctx, fragment)
    const div = body.querySelector('div')
    test.assert(div)
  ...
  async ['div string null'](
    ...
    const fragment = hypertext.html.div({ title })
    const body = await hypertextTest.addFragmentToBody(ctx, fragment)
    const div = body.querySelector('div')
    test.assert(div)
      ...
      () =>
        hypertext.html.div({
          ...
          onAdd(event) {
            ...
            hypertext.scopedDefer(event.ctx, () => {
  ...
  async ['div style'](
    ...
    for (let i = 0; i < 2; i += 1) {
      ...
      test.assertDeepEquals(
        await Promise.all(
          [...ctx.hypertext.styleLayer.cssRules].map(async (item) =>
  ...
  async ['button pure'](
    ...
    const fragment = hypertext.html.button({
      formMethod: 'get',
      type: 'submit',
    })
    const body = await hypertextTest.addFragmentToBody(ctx, fragment)
  ...
  async ['button boolean false'](
    ...
    const fragment = hypertext.html.button({ disabled, type: 'button' })
    const body = await hypertextTest.addFragmentToBody(ctx, fragment)
    const button = body.querySelector('button')
    test.assert(button)
  ...
  async ['input checkbox pure'](
    ...
    const fragment = hypertext.html.input({
      checked: true,
      type: 'checkbox',
    })
    const body = await hypertextTest.addFragmentToBody(ctx, fragment)
