...
import type * as hypertextMath from '@/math.ts'
...
type Actual<Tag extends keyof typeof hypertextMath.math> = Readonly<
  Required<Parameters<(typeof hypertextMath.math)[Tag]>[0]>
>

type Expected<Tag extends keyof MathMLElementTagNameMap> =
  hypertextElementAttrTest.TestAttrs<unknown, MathMLElementTagNameMap[Tag]>
