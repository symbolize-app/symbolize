...
export interface OnAddEvent<BaseElement extends Element> {
  readonly ctx: markupContext.ScopedContext
...
export const allAttrs = {
  ...
  height: stringAttr<markupData.SvgLengthPctOpt>('height'),
  ...
  preserveAspectRatio: stringAttr<markupData.SvgPreserveAspectRatioOpt>(
    'preserveAspectRatio',
  ),
  ...
  rx: stringAttr<markupData.SvgLengthPctOpt>('rx'),
  ry: stringAttr<markupData.SvgLengthPctOpt>('ry'),
  ...
  viewBox: stringAttr<markupData.Rect>('viewBox'),
  width: stringAttr<markupData.SvgLengthPctOpt>('width'),
  x: stringAttr<markupData.SvgLengthPctOpt>('x'),
  y: stringAttr<markupData.SvgLengthPctOpt>('y'),
}
